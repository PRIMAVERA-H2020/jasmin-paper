...
The number of downloads of each variable was published~\citep{Seddon2020c} as this information may be useful when designing the data requests in future projects.
